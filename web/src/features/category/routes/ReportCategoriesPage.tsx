import {useCategoriesForReport} from "@/features/category/hooks/useCategory.ts";
import { useNavigate } from "react-router-dom";

export const ReportCategoriesPage = () => {
    const { data: categories, isLoading, isError } = useCategoriesForReport();
    ...
    return (
        <div className="bg-zinc-100 p-2 mx-auto space-y-4">
            <div className="flex flex-wrap justify-center items-center">
                <h2 className="text-xl font-bold text-zinc-900">Категорії, де кожен товар був проданий</h2>
            </div>
