...
type CategoryRepository interface {
	...
	GetAllCategoriesSortedByName(ctx context.Context, lastCategoryNumber int64) ([]generated.Category, error)
}
...
func (r *categoryRepository) GetAllCategoriesSortedByName(ctx context.Context, lastCategoryNumber int64) ([]generated.Category, error) {
	ctx, cancel := context.WithTimeout(ctx, constants.DatabaseTimeOut)
	defer cancel()
